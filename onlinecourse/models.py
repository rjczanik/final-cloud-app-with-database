...
class Question(models.Model):
    ...
    lesson   = models.ForeignKey(Lesson, default=None, on_delete=models.CASCADE)  # Foreign key to lesson
    question = models.CharField(max_length=500, default="question")  # question text
    grade    = models.FloatField(default=0)  # question grade/mark
